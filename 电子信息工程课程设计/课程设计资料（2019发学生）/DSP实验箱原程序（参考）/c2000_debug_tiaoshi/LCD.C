...
extern void menu_5(void)
{
	...
	GUILCD_writeCharStr(0x00,0x03,3,FALSE);//3
	...
	wr_hex(0,0x010,0x01+3,1);
	wr_hex(0,0x010,0x01+6,FALSE);
	wr_hex(33,0x010,0x01+9,FALSE);
	wr_hex(0,0x010,0x01+12,FALSE);
	wr_hex(0,0x010,0x01+15,FALSE);
	wr_hex(31,0x010,0x01+18,FALSE);//k
