...
#define TRUE  1
#endif
extern float return_hz;
unsigned int baiwei=0;
unsigned int shiwei=0;
unsigned int gewei=0;
unsigned int shifenwei=0;
unsigned int baifenwei=0;
...
void calculate_hz()
{
change=(unsigned int) return_hz;
baiwei=change/100%10;
shiwei=change/10%10;
gewei=change/1%10;
change=(unsigned int)return_hz*10;
shifenwei=change/1%10;
change=(unsigned int)return_hz*100;
baifenwei=change/1%10;
}
...
{
GUILCD_writeCharStr(0x03,0x00,10,FALSE);//请选择
	GUILCD_writeCharStr(0x03,0x01,11,FALSE);
	GUILCD_writeCharStr(0x03,0x02,12,FALSE);
	GUILCD_writeCharStr(0x04,0x00,1,FALSE);//1
	GUILCD_writeCharStr(0x04,0x02,13,FALSE);//fir
	GUILCD_writeCharStr(0x04,0x03,14,FALSE);
	GUILCD_writeCharStr(0x05,0x00,2,FALSE);//2
	GUILCD_writeCharStr(0x05,0x02,15,FALSE);//iir
	GUILCD_writeCharStr(0x05,0x03,16,FALSE);
	GUILCD_writeCharStr(0x06,0x00,3,FALSE);//3
	GUILCD_writeCharStr(0x06,0x02,17,FALSE);//fft
	GUILCD_writeCharStr(0x06,0x03,18,FALSE);
	GUILCD_writeCharStr(0x07,0x00,4,FALSE);//4
	GUILCD_writeCharStr(0x07,0x02,55,FALSE);//AD
	GUILCD_writeCharStr(0x07,0x03,56,FALSE);
/*	GUILCD_writeCharStr(0x00,0x01,65,FALSE);
	GUILCD_writeCharStr(0x00,0x02,66,FALSE);
	GUILCD_writeCharStr(0x00,0x03,67,FALSE);
	GUILCD_writeCharStr(0x00,0x04,68,FALSE);
	GUILCD_writeCharStr(0x00,0x00,64,FALSE);//心电信号采集分析
	GUILCD_writeCharStr(0x00,0x05,69,FALSE);
	GUILCD_writeCharStr(0x00,0x06,70,FALSE);
	GUILCD_writeCharStr(0x00,0x07,71,FALSE);
	GUILCD_writeCharStr(0x01,0x00,85,FALSE);//何超翔
	GUILCD_writeCharStr(0x01,0x01,86,FALSE);
	GUILCD_writeCharStr(0x01,0x02,87,FALSE);
	GUILCD_writeCharStr(0x01,0x03,9,FALSE);//9161010E0509
	GUILCD_writeCharStr(0x01,0x04,1,FALSE);
	GUILCD_writeCharStr(0x01,0x05,6,FALSE);
	GUILCD_writeCharStr(0x01,0x06,1,FALSE);
	GUILCD_writeCharStr(0x01,0x07,0,FALSE);
	GUILCD_writeCharStr(0x01,0x08,1,FALSE);
	GUILCD_writeCharStr(0x01,0x09,0,FALSE);
	GUILCD_writeCharStr(0x01,0x0a,59,FALSE);//E
	GUILCD_writeCharStr(0x01,0x0b,0,FALSE);
	GUILCD_writeCharStr(0x01,0x0c,5,FALSE);
	GUILCD_writeCharStr(0x01,0x0d,0,FALSE);
	GUILCD_writeCharStr(0x01,0x0e,9,FALSE);
	GUILCD_writeCharStr(0x02,0x00,88,FALSE);//邹睿婷
	GUILCD_writeCharStr(0x02,0x01,89,FALSE);
	GUILCD_writeCharStr(0x02,0x02,90,FALSE);
	GUILCD_writeCharStr(0x02,0x03,9,FALSE);//9161040G0811
	GUILCD_writeCharStr(0x02,0x04,1,FALSE);
	GUILCD_writeCharStr(0x02,0x05,6,FALSE);
	GUILCD_writeCharStr(0x02,0x06,1,FALSE);
	GUILCD_writeCharStr(0x02,0x07,0,FALSE);
	GUILCD_writeCharStr(0x02,0x08,4,FALSE);
	GUILCD_writeCharStr(0x02,0x09,0,FALSE);
	GUILCD_writeCharStr(0x02,0x0a,84,FALSE);//G
	GUILCD_writeCharStr(0x02,0x0b,0,FALSE);
	GUILCD_writeCharStr(0x02,0x0c,8,FALSE);
	GUILCD_writeCharStr(0x02,0x0d,1,FALSE);
	GUILCD_writeCharStr(0x02,0x0e,1,FALSE);*/
}
...
extern void menu_4(void)
{
    ...
    calculate_hz();
    GUILCD_writeCharStr(0x03,0x01,baiwei,FALSE);
    GUILCD_writeCharStr(0x03,0x02,shiwei,FALSE);
	GUILCD_writeCharStr(0x03,0x03,gewei,FALSE);
	GUILCD_writeCharStr(0x03,0x05,shifenwei,FALSE);
	GUILCD_writeCharStr(0x03,0x06,baifenwei,FALSE);
}
...
extern void menu_5(void)
{
    ...
    wr_hex(0,0x010,0x05+9,1);
    wr_hex(0,0x010,0x05,FALSE);
	wr_hex(0,0x010,0x05+6,FALSE);
