...
for i=1:size(R_1,1)
    for j=2:size(R_1,2)
rectangle('Position',[R_1(i,j) R_1(i,1) 201 373],'EdgeColor', 'b', 'LineWidth', 2)
axis equal
hold on;
    end
end
...
for i=1:size(R_2,1)
rectangle('Position',[R_2(i,1) R_2(i,2) 373 201],'EdgeColor', 'b', 'LineWidth', 2)
axis equal
hold on;
end

for i=1:size(R_3,1)
rectangle('Position',[R_3(i,1) R_3(i,2) 406 229],'EdgeColor', 'r', 'LineWidth', 2)
axis equal
hold on;
end
for i=1:size(R_4,1)
rectangle('Position',[R_4(i,1) R_4(i,2) 229 406],'EdgeColor', 'r', 'LineWidth', 2)
axis equal
hold on;
end
for i=1:size(R_5,1)
rectangle('Position',[R_5(i,1) R_5(i,2) 201 373],'EdgeColor', 'b', 'LineWidth', 2)
axis equal
hold on;
end
for i=1:size(R_6,1)
rectangle('Position',[R_6(i,1) R_6(i,2) 373 201],'EdgeColor', 'b', 'LineWidth', 2)
axis equal
hold on;
end
